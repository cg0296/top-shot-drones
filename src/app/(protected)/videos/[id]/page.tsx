        ...
        <div className="flex items-start justify-between gap-4">
          ...
          {(user.role === 'ADMIN' || user.role === 'STAFF') && (
            <Link
              ...
              className="shrink-0 inline-flex items-center gap-1.5 rounded-lg border border-[var(--border)] bg-[var(--bg-card)] px-3 py-1.5 text-xs font-medium text-[var(--text-secondary)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
            >
